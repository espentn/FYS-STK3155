...
The boostrap resampling method is a simple Monte Carlo technique to approximate the sampling distribution. 
\subsection{k-fold Cross Validation}
As the name implies, the k-fold Cross Validation 
\section{Data}
