...
The metrics were then applied to both sets and the R2 coefficient and the Mean Square Error of each set were calculated. In addition, we generated a plot of the confidence intervals of the tunable parameters, shown in figure \ref{fig:confintOLS}.
...
\subfloat[legend]{\label{a}\includegraphics[width=.45\linewidth]{partBplot10.png}}\hfill
\subfloat[legend]{\label{b}\includegraphics[width=.45\linewidth]{partBplot40.png}} \par
\subfloat[legend]{\label{c}\includegraphics[width=.45\linewidth]{partBplot70.png}}\hfill
\subfloat[legend]{\label{c}\includegraphics[width=.45\linewidth]{partBplot100.png}}\par
