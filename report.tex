...
\end{align*}
\section{Method}
The Franke function is a multivariable function, depending on both $x$ and $y$, and hence is a 2-variable polynomial of degree N. The design matrix in \ref{designM} thus needs to be adjusted for this multivariable case. The 
