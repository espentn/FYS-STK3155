...
\subfloat[legend]{\label{a}\includegraphics[width=.45\linewidth]{Plots/partBplot10.jpg}}\hfill
\subfloat[legend]{\label{b}\includegraphics[width=.45\linewidth]{Plots/partBplot20.jpg}} \par
\subfloat[legend]{\label{c}\includegraphics[width=.45\linewidth]{Plots/partBplot30.jpg}}
...
\subfloat[$\lambda=0.0001$]{\label{a}\includegraphics[width=.45\linewidth]{CIbetaridgelambda0.0001.png}}\hfill
\subfloat[$\lambda=0.0046$]{\label{b}\includegraphics[width=.45\linewidth]{CIbetaridgelambda0.004641588833612782.png}} \par
\subfloat[$\lambda=0.2154$]{\label{c}\includegraphics[width=.45\linewidth]{CIbetaridgelambda0.21544346900318845.png}}
\subfloat[$\lambda=10.0$]{\label{c}\includegraphics[width=.45\linewidth]{CIbetaridgelambda10.0.png}}
...
\begin{figure}[h]\centering
\subfloat[$\lambda=0.0001$]{\label{a}\includegraphics[width=.45\linewidth]{boostrapridge0.png}}\hfill
\subfloat[$\lambda=0.0046$]{\label{b}\includegraphics[width=.45\linewidth]{boostrapridge1.png}} \par
\subfloat[$\lambda=0.2154$]{\label{c}\includegraphics[width=.45\linewidth]{boostrapridge2.png}}\hfill
\subfloat[$\lambda=10.0$]{\label{c}\includegraphics[width=.45\linewidth]{boostrapridge3.png}}\par
...
\begin{figure}[h]\centering
\subfloat[$\lambda=0.0001$]{\label{a}\includegraphics[width=.45\linewidth]{boostraplasso0_cut.png}}\hfill
\subfloat[$\lambda=0.0046$]{\label{b}\includegraphics[width=.45\linewidth]{boostraplasso1_cut.png}} \par
\subfloat[$\lambda=0.2154$]{\label{c}\includegraphics[width=.45\linewidth]{boostraplasso2_cut.png}}\hfill
\subfloat[$\lambda=10.0$]{\label{c}\includegraphics[width=.45\linewidth]{boostraplasso3_cut.png}}\par
...
\begin{figure}[h]
\includegraphics[scale=0.9]{terrain2dplot.png}
...
\begin{tabular}{||c c||} 
 ...
 \hline
\end{tabular}
\caption{Mean MSE scores for OLS on the terrain data with increasing polynomial degree}
\label{table:1}
\end{table}
...
\hline
\end{tabular}
\caption{Mean MSE scores for Ridge on the terrain data with increasing polynomial degree and $\lambda$}
\label{tbl:2}
\end{table}
...
\hline
\end{tabular}
\caption{Mean MSE scores for Lasso on the terrain data with increasing polynomial degree and $\lambda$}
\label{tbl:3}
\end{table}
